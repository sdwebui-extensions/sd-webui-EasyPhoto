...
models_path, easyphoto_img2img_samples, easyphoto_outpath_samples, user_id_outpath_samples, cache_outpath_samples, id_path = get_ui_paths()
        ...
        with gr.TabItem('Inference'):
            ...
            with gr.Blocks() as demo:
                ...
                display_button.click(
                    ...
                    inputs=[sd_model_checkpoint, webui_id, selected_template_images, init_image, additional_prompt, 
